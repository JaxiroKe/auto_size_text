...
void main() {
  testWidgets('Only Text', (tester) async {
    await pump(
      tester: tester,
      widget: testWidget(const AutoSizeText.selectable('Some Text')),
    );
  });
  ...
  testWidgets('Only text (rich)', (tester) async {
    await pump(
      tester: tester,
      widget: testWidget(const AutoSizeText.richSelectable(TextSpan(text: 'Some Text'))),
    );
  });
  ...
  testWidgets('Uses style fontSize', (tester) async {
    await pumpAndExpectFontSize(
      ...
      expectedFontSize: 34,
      selectable: true,
      widget: testWidget(const AutoSizeText.selectable(
        'Some Text',
  ...
  testWidgets('Uses style fontSize (rich)', (tester) async {
    await pumpAndExpectFontSize(
      ...
      expectedFontSize: 35,
      selectable: true,
      widget: testWidget(const AutoSizeText.richSelectable(
